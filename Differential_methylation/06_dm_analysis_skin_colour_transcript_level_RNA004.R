#DGE analyses script
# by NS
#intended for use with output from 04_edgeR_methylation_transcript_level_RNA004 script
...
###~~output dir~~~~~~~~~~~~~~####
output = "../06_dm_analysis_skin_transcript_level_RNA004/"
...
em_file="../04_edgeR_methylation_transcript_level_RNA004/cpm_skin.csv" #methylation matrix with CPM
de_file_start="../04_edgeR_methylation_transcript_level_RNA004/results_" #differential methylation output from edgeR
