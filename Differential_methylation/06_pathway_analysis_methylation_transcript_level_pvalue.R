...
for (analysis in analyses) {
  ...
  sig_genes = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_sig_fdr.txt",sep = ""))
  sig_up = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_sig_up.txt",sep = ""))
  sig_down = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_sig_down.txt",sep = ""))
