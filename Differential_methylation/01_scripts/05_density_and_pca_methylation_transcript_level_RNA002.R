...
dir.create("../05_density_pca_skin_colour_methylation_transcript_level_RNA002") #make folder for output
setwd("../05_density_pca_skin_colour_methylation_transcript_level_RNA002") #set output folder as wd

###~~specify data~~~~~~~~~~~~####

ss_file=("../02_reference_data/sample_sheet.csv") #sample sheet
em_file_skin=("../04_edgeR_methylation_transcript_level_RNA002/cpm_skin.csv") #expression matrix with CPM
log2cpm_file_skin=("../04_edgeR_methylation_transcript_level_RNA002/log2cpm_skin.csv")
