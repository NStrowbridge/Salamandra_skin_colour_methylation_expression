# pathway analysis script for gene methylation
# by Nic Strowbridge
...
output = "../07_dge_pathway_analysis_methylation_transcript_level"
dir.create(output) 
...
for (analysis in analyses) {
  ...
  ###~~gene lists~~~~~~~~~~~~~~####
  gene_universe = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_gene_universe.txt",sep = ""))
  sig_fdr_genes = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_sig_fdr.txt",sep = ""))
  sig_fdr_up = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_fdr_up.txt",sep = ""))
  sig_fdr_down = read_lines(paste("../06_dm_analysis_skin_transcript_level/",anal_dir,"/mapped_genes_fdr_down.txt",sep = ""))
  ...
  setwd(anal_dir)
  gene_lists=c("sig_fdr_genes","sig_fdr_up","sig_fdr_down")
