...
setwd(paste0("/Users/nicstrowbridge/Desktop/Nic_PhD_files_2/DirectRNA_Colour_bernardezi/Differential_expression/01_scripts")) #set wd to Scripts folderdir.create("../05_density_pca") #make folder for output
dir.create("../05_density_pca_expression") #make folder for output
setwd("../05_density_pca_expression") #set output folder as wd

###~~specify data~~~~~~~~~~~~####

ss_file=("../02_reference_data/sample_sheet.csv") #sample sheet
em_file_skin=("../04_edge_R_transcript_level_skin_colour/cpm_skin.csv") #expression matrix with CPM
em_file_morph=("../04_edge_R_transcript_level_skin_colour/cpm_morph.csv") #expression matrix with CPM
log2cpm_file_skin=("../04_edge_R_transcript_level_skin_colour/log2cpm_skin.csv")
log2cpm_file_morph=("../04_edge_R_transcript_level_skin_colour/log2cpm_skin.csv")
...
#~~~~save plot~~~~~~~~~~~~~~~####
svglite("density_expression_skin.svg", width = 4, height = 4)
...
#~~~~save plot~~~~~~~~~~~~~~~####
svglite("density_faceted_expression_skin.svg")
