...
###~~output directory~~~~~~~~####
output = "../04_edge_R_transcript_level_skin_morphxlandmark/" #specify where the output should go
...
res.Yel_dorvYel_lat = topTags(qlf.Yel_dorvStri_dor, n=nrow(y), sort.by = "PValue")
