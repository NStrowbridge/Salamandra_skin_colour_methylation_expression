#DGE analyses script
# by NS
#intended for use with output from 04_edge_R_transcript_level_skin_colour script
...
###~~output dir~~~~~~~~~~~~~~####
output = "../06_dge_analysis_skin_morphxlandmark/"
...
em_file="../04_edge_R_transcript_level_skin_morphxlandmark/cpm_skin.csv" #expression matrix with CPM
de_file_start="../04_edge_R_transcript_level_skin_morphxlandmark/results_" #differential expression output from edgeR
analyses = c("StrixdorvStrixlat")
custom_colors <- c("Striped_dor" = "yellow", "Striped_lat" = "grey", "Brown" = "brown")
...
gene_data$sample_group=ss$Morph.landmark
