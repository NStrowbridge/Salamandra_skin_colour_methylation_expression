# pathway analysis script for gene expression
# by Nic Strowbridge
...
output = "../07_dge_pathway_analysis_expression"
dir.create(output) 
...
for (analysis in analyses) {
  ...
  ###~~gene lists~~~~~~~~~~~~~~####
  gene_universe = read_lines(paste("../06_dge_analysis_skin_colour/",anal_dir,"/mapped_gene_universe.txt",sep = ""))
  sig_fdr_genes = read_lines(paste("../06_dge_analysis_skin_colour/",anal_dir,"/mapped_genes_sig_fdr.txt",sep = ""))
  sig_fdr_up = read_lines(paste("../06_dge_analysis_skin_colour/",anal_dir,"/mapped_genes_fdr_up.txt",sep = ""))
  sig_fdr_down = read_lines(paste("../06_dge_analysis_skin_colour/",anal_dir,"/mapped_genes_fdr_down.txt",sep = ""))
