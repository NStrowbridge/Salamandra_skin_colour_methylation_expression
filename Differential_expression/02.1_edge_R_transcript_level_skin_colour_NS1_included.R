...
###~~output directory~~~~~~~~####
output = "../04_edge_R_transcript_level_skin_colour_ns1_included/" #specify where the output should go
...
###~~sample sheet~~~~~~~~~~~~####
ss = read.csv(paste(refdata,"sample_sheet_NS1_included.csv",sep = ""), row.names = 1)
