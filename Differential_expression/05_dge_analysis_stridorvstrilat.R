...
###~~output dir~~~~~~~~~~~~~~####
output = "../06_dge_analysis_stridorvstrilat/"
...
em_file="../04_edge_R_transcript_level_skin_stridorxstrilat/cpm_skin.csv" #expression matrix with CPM
de_file_start="../04_edge_R_transcript_level_skin_stridorxstrilat/results_" #differential expression output from edgeR
